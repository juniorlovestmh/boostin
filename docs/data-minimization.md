...
| Entity | Purpose | Retained locally | Public report |
| --- | --- | --- | --- |
| Own post body | Private review and drafting | Yes | No |
| Post URL | Match first-party analytics | Yes | No |
| Post metrics | Weekly learning loop | Yes | Aggregate only |
| Profile aggregates | Longitudinal context | Yes | Opt-in later; excluded in v1 |
| Drafts | Content preparation | Yes | No |
